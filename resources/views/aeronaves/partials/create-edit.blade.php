...
<div class="container">
    ...
    <input type="text" name="modelo" id="modelo" value="{{old('modelo',  $aeronave->modelo)}}" required>
</div>

<div class="container">
    <label for="num_lugares" class="mr-2">Numero de Lugares: </label>
    <input type="text" name="num_lugares" id="num_lugares" value="{{old('num_lugares', $aeronave->num_lugares)}}"
        required>
</div>

<div class="container">
    <label for="conta_horas" class="mr-2">Conta-Horas: </label>
    <input type="text" name="conta_horas" id="conta_horas" value="{{ old('conta_horas',$aeronave->conta_horas)}}"
        required>
</div>
