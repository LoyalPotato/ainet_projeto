...
<div class="form-group">
    ...
    <input
        ...
        name="numeroSocio" id="inputNumeroSocio"
        placeholder="numeroSocio" value="{{old('NumeroSocio', $user->numeroSocio)}}" />
</div>
<div class="form-group">
    ...
    <input
        ...
        placeholder="nomeInformal" value="{{old('nomeInformal', $user->nomeInformal)}}" />
</div>
<div class="form-group">
    <label for="inputNomeCompleto">Nome Completo</label>
    <input
        type="text" class="form-control"
        name="nomeCompleto" id="inputNomeCompleto"
        placeholder="nomeCompleto" value="{{old('nomeCompleto', $user->nomeCompleto)}}" />
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input
        ...
        placeholder="dataNascimento" value="{{old('dataNascimento', $user->dataNascimento)}}" />
</div>
<div class="form-group">
